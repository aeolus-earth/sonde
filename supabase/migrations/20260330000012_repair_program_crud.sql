-- Repair: apply program CRUD RPCs that were skipped when migration 000006 was
-- recorded under the wrong name (activity_actions_update instead of program_crud).
-- This is the same SQL as 20260330000006_program_crud.sql.

-- Archive support columns
