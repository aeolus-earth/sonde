-- experiment_summary: expose content, related, data_sources, metadata, claimed_*, updated_at
-- so the UI list filter can search markdown body and avoid undefined related[] at runtime.
